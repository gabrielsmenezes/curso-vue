	...
	<div id="app">
		...
		<div class="conteudo">
			<form class="painel" v-if="!enviado">
				...
				<Rotulo nome="E-mail">
					<input v-model.lazy="usuario.email" type="text">
				</Rotulo>
				<Rotulo nome="Senha">
					<input v-model.trim="usuario.senha" type="password">
				</Rotulo>
				<Rotulo nome="Idade">
				...
				<Rotulo nome="Prioridade">
					<select v-model="prioridade">
						<option v-for="prioridade in prioridades" v-bind:key="prioridade" v-bind:value="prioridade.codigo">
							{{prioridade.nome}}
						</option>
					</select>
				</Rotulo>
			...
			<div class="painel" v-if="enviado">
				...
				<Rotulo nome="Marque as Opções">
					<span>
						<ul>
							<li v-for="caracteristica in caracteristicas" v-bind:key="caracteristica">
